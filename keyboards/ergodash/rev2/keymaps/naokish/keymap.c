...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+---------------------------+------+------+------+------+------+------+------|
   * | Shift|   Z  |   X  |   C  |   V  |   B  | EISU |                    |  Del |   N  |   M  |   ,  |   .  |   /  | Shift|
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
   * | Lower|  ALt |  GUI | Shift|||||||| Ctrl | Lower|   -  |||||||| Bksp | Raise|Coding|||||||| Shift|  GUI |  ALt | Lower|
   * ,----------------------------------------------------------------------------------------------------------------------.
   */
  [_QWERTY] = LAYOUT( \
    ...
    KC_LSFT, KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,    EISU,                         KC_DEL,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, \
    LOWER,   KC_LALT,KC_LGUI, KC_LSFT,          KC_RCTL, LOWER,  KC_MINS,    KC_BSPC,  RAISE , CODING,            KC_RSFT, KC_RGUI, KC_RALT, LOWER    \
  ),
   ...
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
   * | Lower|  ALt |  GUI | Shift|||||||| Ctrl | Lower| EISU |||||||| Bksp | Raise|Coding|||||||| Home |PageDn|PageUp|  End |
   * ,----------------------------------------------------------------------------------------------------------------------.
   */
  [_LOWER] = LAYOUT(
    ...
    LOWER,   KC_LALT, KC_LGUI, KC_LSFT,          KC_RCTL, LOWER,  EISU,         KC_BSPC,  RAISE , CODING,            KC_HOME, KC_PGDN, KC_PGUP, KC_END   \
  ),
   ...
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
   * | Lower|  ALt |   0  | Shift|||||||| Ctrl | Lower|   -  |||||||| Bksp | Raise|Coding|||||||| Home |PageDn|PageUp|  End |
   * ,----------------------------------------------------------------------------------------------------------------------.
   */
  [_CODING] = LAYOUT(
    KC_TILD, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_UNDS,                        KC_EQL,  KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_DEL,  \
    KC_TAB,  KC_1,    KC_2,    KC_3,    KC_EXLM, KC_EQL,  KC_LT,                          KC_GT,   KC_LPRN, KC_RPRN, KC_ASTR, KC_UNDS, KC_F12,  KC_BSPC, \
    KC_LCTL, KC_4,    KC_5,    KC_6,    KC_PLUS, KC_MINS, KC_QUOT,                        KC_DQT,  KC_LCBR, KC_RCBR, KC_K,    KC_COLN, KC_SCLN, KC_ENT , \
    KC_LSFT, KC_7,    KC_8,    KC_9,    KC_ASTR, KC_SLSH, KC_ESC,                         KC_DEL , KC_LBRC, KC_RBRC, KC_AMPR, KC_PIPE, KC_QUES, KC_RSFT, \
    LOWER,   KC_LALT, KC_0, KC_LSFT,             KC_RCTL, LOWER,  KC_MINS,      KC_BSPC,  RAISE,   CODING,           KC_HOME, KC_PGDN, KC_PGUP, KC_END   \
  ),
